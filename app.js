(() => {
  ...
  function exportCompareMatrix() {
    ...
    const exportStyles = `body{font-family:Inter,Segoe UI,Arial,sans-serif;color:#1f1b2e;background:#ffffff;margin:32px;}h1{margin:0 0 12px;font-size:20px;}p.summary{margin:0 0 20px;color:#524a79;max-width:72ch;}table{border-collapse:collapse;width:100%;box-shadow:0 6px 20px rgba(124,58,237,0.08);}thead th{background:#ede9fe;color:#4c1d95;font-size:12px;letter-spacing:0.08em;text-transform:uppercase;}th,td{border:1px solid #dcd3fb;padding:10px 14px;text-align:left;vertical-align:top;font-size:14px;}tbody tr:nth-child(odd){background:#f3eeff;}td.compare-cell{min-width:150px;}td.compare-cell .price{display:block;font-weight:700;font-size:16px;margin-bottom:4px;}td.compare-cell .meta{display:block;font-size:12px;color:#524a79;line-height:1.35;}td.compare-cell.is-empty{text-align:center;font-style:italic;color:#6b6a87;}td.compare-cell.is-active{box-shadow:inset 0 0 0 2px #7c3aed;border-radius:10px;}td.compare-cell.is-best .price{color:#047857;}td.compare-cell.heat-best{background:linear-gradient(135deg,rgba(16,185,129,.24),rgba(16,185,129,.08));}td.compare-cell.heat-good{background:linear-gradient(135deg,rgba(34,197,94,.22),rgba(34,197,94,.06));}td.compare-cell.heat-mid{background:linear-gradient(135deg,rgba(245,158,11,.22),rgba(245,158,11,.06));}td.compare-cell.heat-warm{background:linear-gradient(135deg,rgba(249,115,22,.24),rgba(249,115,22,.08));}td.compare-cell.heat-hot{background:linear-gradient(135deg,rgba(239,68,68,.25),rgba(239,68,68,.1));}`;
