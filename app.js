    ...
    try {
      ...
      const headerRow = new docx.TableRow({
        ...
        children: ['Item', 'Details', 'Qty', 'Unit', 'Total'].map((text) =>
          new docx.TableCell({
            ...
            shading: applyShadeType({ fill: 'F5F1FF', color: 'FFFFFF' }, 'PERCENT_10'),
      ...
      const bodyRows = data.rows.map((row, index) => {
        const zebraShadeFactory = () => (index % 2 === 0
          ...
          : applyShadeType({ fill: 'FDFCFF', color: 'FFFFFF' }, 'PERCENT_10'));
      ...
      const totalRow = new docx.TableRow({
        children: [
          new docx.TableCell({
            ...
            shading: applyShadeType({ fill: 'E3D6FF', color: 'FFFFFF' }, 'PERCENT_20'),
