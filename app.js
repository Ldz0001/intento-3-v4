    ...
    try {
      ...
      const headerRow = new docx.TableRow({
        ...
        children: ['Item', 'Details', 'Qty', 'Unit', 'Total'].map((text) =>
          new docx.TableCell({
            ...
            shading: applyShadeType({ fill: 'F9F7FF', color: 'FFFFFF' }, 'PERCENT_10'),
      ...
      const bodyRows = data.rows.map((row, index) => {
        const zebraShadeFactory = () => (index % 2 === 0
          ...
          : applyShadeType({ fill: 'FBF8FF', color: 'FFFFFF' }, 'PERCENT_10'));
      ...
      const totalRow = new docx.TableRow({
        children: [
          new docx.TableCell({
            ...
            shading: applyShadeType({ fill: 'C9B5FF', color: 'FFFFFF' }, 'PERCENT_20'),
